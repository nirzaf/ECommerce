...
namespace Grand.Web.Controllers
{
    public partial class CustomerController : BasePublicController
    {
        ...
        public ActionResult PasswordRecoverySend(PasswordRecoveryModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                if (customer != null && customer.Active && !customer.Deleted)
                {
                    ...
                    _workContext.CurrentCustomer.GenericAttributes = customer.GenericAttributes;
        ...
        public ActionResult UserAgreement(Guid orderItemId)
        {
            ...
            var product = Grand.Core.Infrastructure.EngineContext.Current.Resolve<IProductService>().GetProductById(orderItem.ProductId);
